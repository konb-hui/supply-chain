...
<table id="wrap">
	...
	</span>&nbsp;&nbsp;共有${pageResult_zhub.totalSize}条记录，当前第 ${pageResult_zhub.currentPage}/${pageResult_zhub.totalPages}页</p>
           </div>
		</td>
    </tr>
	...
	</span>&nbsp;&nbsp;共有${pageResult_zhib.totalSize}条记录，当前第 ${pageResult_zhib.currentPage}/${pageResult_zhib.totalPages}页</p>
           </div>
    	</td>
    </tr>
    </s:form>
